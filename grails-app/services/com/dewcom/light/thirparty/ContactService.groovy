...
import com.dewcom.light.rest.thirdparty.ContactRequest
import com.dewcom.light.rest.thirdparty.UpdateContactRequest
...
class ContactService {
    ...
    def createContact(ContactRequest pcontact) {
        try {
    ...
    def updateContact(UpdateContactRequest argRestContact) {
        try {
    ...
    def static fromRestContact(ContactRequest pContactRest){
